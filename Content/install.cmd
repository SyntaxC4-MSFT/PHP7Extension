...
curl -L -o SQLSVR.zip https://github.com/Azure/msphpsql/releases/download/v4.0-RC/php_sqlsrv_4.0.5_x86.zip
start /wait d:\7zip\7za.exe x SQLSVR.zip -oSQLSVR

curl -L -o SQLSVRPDO.zip https://github.com/Azure/msphpsql/releases/download/v4.0-RC/php_pdo_sqlsrv_4.0.5_x86.zip
start /wait d:\7zip\7za.exe x SQLSVRPDO.zip -oSQLSVR

curl -L -o REDIS.zip http://windows.php.net/downloads/pecl/releases/redis/3.0.0/php_redis-3.0.0-7.0-nts-vc14-x86.zip
...
cp d:\home\SiteExtensions\PHP7Extension\Commands\SQLSVR\php_sqlsrv_4.0.5_x86\php_sqlsrv_7_nts.dll .\php_sqlsrv.dll
cp d:\home\SiteExtensions\PHP7Extension\Commands\SQLSVR\php_pdo_sqlsrv_4.0.5_x86\php_pdo_sqlsrv_7_nts.dll .\php_pdo_sqlsrv.dll
